...
const Screen6 = ({navigation, status}) => {
    ...
    <>
      ...
      //zoomControlEnabled={true}
       ...
       >
         ...
         <SafeAreaView style={[styles.miniContainer, {height: 256, paddingHorizontal: 0}]}>
         ...
         <View style={{
           ...
           }}>Rate your trip with Samuel</Text>
           {/* <CustomizedStarRating
                 noOfStars={'5'}
                 starRowStyle={styles.starRowStyle}
                 starSizeStyle={styles.starSizeStyle}
                 selectedStar={filledStar}
                 starAnimationScale={1}
                 animationDuration={100}
                 easingType={Easing.circle}
                 emptyStarImagePath={require('../assets/icon/emptyStar.png')}
                 filledStarImagePath={require('../assets/icon/fullStar.png')}
                 onClickFunc={({i}) => click(i)}
             /> */}
             <View>
             <StarRating
                 rating={filledStar}
       ...
       />
           ...
           _onPress={()=>{
            status(
              <>
              <Screen1 navigation={navigation} status={status}/>
              </>
            )
           }}
           title="Confirm"
